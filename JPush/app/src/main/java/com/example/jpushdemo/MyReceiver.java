...
//            Log.d(TAG, "[MyReceiver] 用户点击打开了通知");
        	...
        	//打开自定义的Activity；修改此处的Activity就可以指向自定义的Activity
        	Intent i = new Intent(context, com.ggtf.jpushdemo.MainActivity.class);
        	i.putExtras(bundle);
        	//i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
			/**
			 * 设置Intent的标签；打开的Activity不存在就创建一个新的任务栈，
			 * 如果Activity已经存在，就清除当前Activity之上的Activity
			 */
